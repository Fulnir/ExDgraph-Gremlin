defmodule ExdgraphGremlin do
  ...
  require Logger
  import ExdgraphGremlin.LowLevel
  import ExdgraphGremlin.Graph
  ...
  def addV(graph, struct_type) do
    ...
    case mutate_node(graph, "vertex_type", vertex_type) do
      ...
      {:error, error} ->
        # * %ExdgraphGremlin.GremlinError{status: error.status, message: error.message}
